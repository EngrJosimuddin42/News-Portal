                          ...
                          Obx(() => Wrap(
                            ...
                            children: controller.suggestions.map((s) => GestureDetector(
                              ...
                              child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      color: Get.isDarkMode ? const Color(0xFF383838) : Colors.white,
                                      border: Border.all(color: AppColors.border),
                                      borderRadius: BorderRadius.circular(60.r)),
                                  child: Text(s, style: AppTextStyles.labelMedium.copyWith(
                                      color: AppColors.white, letterSpacing: 0, height: 1.0))),
                            )).toList(),
                          )),
                        ],
                      ),
                  ...
                  children: [
                    ...
                    Obx(() => GestureDetector(
                      ...
                      child: controller.isResponding.value
                          ...
                          width: 32.w, height: 32.h,
                          colorFilter: ColorFilter.mode(const Color(0xFFB8B8B8), BlendMode.srcIn)),
                    )),
                  ],
                ),
              ),
