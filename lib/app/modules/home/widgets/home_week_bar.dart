          ...
          children: [
            ...
            Row(
              ...
              children: List.generate(_days.length, (i) {
                ...
                final Color unselectedColor = Get.isDarkMode ? const Color(0xFF6C6C6C) : const Color(0xFF6C6C6C);
                final Color selectedColor = Get.isDarkMode ? const Color(0xFFFFFFFF) : const Color(0xFF242424);
            ...
            Text(controller.monthAndDay, style:AppTextStyles.tagline.copyWith(
                color: Get.isDarkMode ? const Color(0xFFD9D9D9) : const Color(0xFF242424))),
