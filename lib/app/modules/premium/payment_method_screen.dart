  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Payment Method', style: AppTextStyles.displaySmall.copyWith(color: AppColors.white)),
        centerTitle: true,
        elevation: 0),
      body: Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color:Get.isDarkMode? Color(0xFF333333):Colors.white,
                      border: Border.all(color: AppColors.border),
                      borderRadius: BorderRadius.circular(8.r)),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(method, style: AppTextStyles.caption.copyWith(color: AppColors.white)),
                        Icon(
            ...
            Obx(() => controller.selectedMethod.value == null
              ...
              child: ElevatedButton(
                ...
                child: controller.isLoading.value
                    ...
                    : Text('Continue', style: AppTextStyles.caption.copyWith(color: AppColors.white))))),
